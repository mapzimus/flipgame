...
(function (root, factory) {
  ...
  const PROFILES = freezeDeep({
    bottle:       profile('sealed-liquid', true, false, face(0, -31, 0.82, 48)),
    ketchup:      profile('sealed-liquid', true, false, face(0, -22, 0.78, 46), { viscosity: 0.78 }),
    maple:        profile('sealed-liquid', true, false, face(0, -25, 0.82, 48), { viscosity: 0.68 }),
    honeybear:    profile('sealed-liquid', true, false, face(0, -84, 0.82, 50), { viscosity: 0.84 }),
    babybottle:   profile('sealed-liquid', true, false, face(0, -35, 0.78, 46)),
    extinguisher: profile('flexible-hose', true, false, face(0, -33, 0.78, 48)),
    soap:         profile('sealed-liquid-bubbles', true, false, face(0, -27, 0.78, 48)),
    hourglass:    profile('granular', true, false, face(0, -22, 0.75, 46)),
    bowlingpin:   profile('rigid', false, false, face(0, -55, 0.82, 48)),
    cone:         profile('rigid', false, false, face(0, -18, 0.82, 50)),
    flask:        profile('open-liquid', true, true, face(0, -31, 0.82, 50)),
    shell:        profile('rigid', false, false, face(0, -26, 0.76, 46)),
    pawn:         profile('rigid', false, false, face(0, -46, 0.84, 50)),
    buoy:         profile('rigid', false, false, face(0, -47, 0.78, 46)),
    wineglass:    profile('open-liquid', true, true, face(0, -91, 0.76, 48)),
    toucan:       profile('flexible-wing', true, false, face(21, -128, 0.62, 46)),
    ...
    potion:       profile('sealed-liquid-suspension', true, false, face(0, -29, 0.78, 48)),
    tabasco:      profile('sealed-liquid', true, false, face(0, -28, 0.72, 44), { viscosity: 0.42 }),
    coke:         profile('sealed-carbonated', true, false, face(0, -34, 0.72, 44)),
    stanley:      profile('sealed-opaque', false, false, face(0, -25, 0.8, 48)),
    lavalamp:     profile('sealed-globules', true, false, face(0, -31, 0.76, 48)),
    lawnchair:    profile('rigid', false, false, face(0, -37, 0.82, 50)),
    octopus:      profile('flexible-tentacles', true, false, face(0, -80, 0.82, 54)),
