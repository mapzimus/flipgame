...
- Only the literal Earth sphere becomes realistic 3D. The stand, meridian, base,
...
| Desk Globe art | Only the Earth sphere uses realistic 3D treatment; its styled stand/base and competitive collider remain unchanged. A deterministic rotation corpus exposes every longitude, geography remains recognizable at picker/gameplay sizes, and the sphere requires no network resource. |
